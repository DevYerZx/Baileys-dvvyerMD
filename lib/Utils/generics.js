...
const DVYER_PROFILE = Object.freeze({
    name: 'dvyer',
    tagline: 'Custom WhatsApp automation toolkit',
    github: 'https://github.com/dvyer'
})

const Dvyer = async () => ({ ...DVYER_PROFILE })

// Backward-compatible alias for older integrations importing "Itsuki"
const Itsuki = Dvyer
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/dvyer/Baileys/refs/heads/master/lib/Defaults/baileys-version.json'
    try {
