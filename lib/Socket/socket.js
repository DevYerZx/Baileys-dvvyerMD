...
const makeSocket = (config) => {
   ...
   /** ephemeral key pair used to encrypt/decrypt communication. Unique for each connection */
    ...
    const requestPairingCode = async (phoneNumber, code) => {
        const normalizedPhone = normalizePhoneNumberForPairing(phoneNumber)
        const normalizedPairingCode = normalizePairingCode(code)

        authState.creds.pairingCode = normalizedPairingCode
        
        authState.creds.me = {
            id: jidEncode(normalizedPhone, 's.whatsapp.net'),
            name: '~'
        }
